...
if DevAbs:get(DOES.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(DOES.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(DOES.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(DOES.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(DOES.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(DOES.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DOESName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DOESName then 
DOESNames = DevAbs:smembers(DOES.."Abs:Mute:Names"..msg.chat_id_) or ""
if DOESNames and DOESNames[1] then 
for i=1,#DOESNames do 
if DOESName:match("(.*)("..DOESNames[i]..")(.*)") then 
...
DevAbs:set(DOES.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(DOES.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
